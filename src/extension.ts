...
class WaveformViewerProvider implements vscode.CustomReadonlyEditorProvider<VaporviewDocument> {
  ...
  async openCustomDocument(
    ...
    await vscode.window.withProgress({
      ...
      await parseVCDData(uri.fsPath, netlistTreeDataProvider, waveformDataSet, netlistIdTable, progress);
...
async function parseVCDData(path: string, netlistTreeDataProvider: NetlistTreeDataProvider, waveformDataSet: WaveformTop, netlistIdTable: NetlistIdTable, progress: vscode.Progress<{ message?: string; increment?: number; }>) {
